...
<div class=\"body_padded\">
	<h2>About</h2>
	<p>MTN Hackers Platform (DVWA) is a PHP/MySQL web application that is damn vulnerable. Its main goals are to be an aid for security professionals to test their skills and tools in a legal environment, help web developers better understand the processes of securing web applications and aid teachers/students to teach/learn web application security in a class room environment</p>
	...
	<h2>License</h2>
	<p>MTN Hackers Platform (DVWA) is free software: you can redistribute it and/or modify
