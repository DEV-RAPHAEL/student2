...
function &dvwaPageNewGrab() {
	$returnArray = array(
		'title'           => 'MTN Hackers Platform (DVWA) v' . dvwaVersionGet() . '',
		'title_separator' => ' :: ',
		'body'            => '',
		'page_id'         => '',
		'help_button'     => '',
	...
	<body class=\"home\">
		<div id=\"container\">
			...
			<div id=\"header\">
				...
				<img src=\"" . DVWA_WEB_PAGE_TO_ROOT . "dvwa/images/logo.png\" alt=\"MTN Hackers Platform\" />
			...
			<div id=\"footer\">
				...
				<p>MTN Hackers Platform (DVWA) v" . dvwaVersionGet() . "</p>
