...
MTN Hackers Platform (DVWA), son derece zafiyetli bir PHP/MySQL web uygulamasıdır. Temel amacı; güvenlik uzmanlarına, yeteneklerini ve araçlarını test etmeleri konusunda yasal bir ortam sunmak, web geliştiricilerinin web uygulamalarının güvenliğini sağlama süreçlerini daha iyi anlamalarına yardımcı olmak, öğrencilere ve eğitmenlere web uygulamalarının güvenliğini öğrenme/öğretme konusunda kontrollü bir sınıf ortamı sunmaktır.
...
Bu dosya, MTN Hackers Platform'ın (DVWA) bir parçasıdır.

MTN Hackers Platform (DVWA) bir özgür yazılımdır. Yazılımı; Özgür Yazılım Vakfı
...
MTN Hackers Platform (DVWA), faydalı olması umuduyla, ancak HERHANGİ BİR GARANTİ OLMADAN,
...
MTN Hackers Platform (DVWA) ile birlikte, GNU Genel Kamu Lisansı'nın da bir kopyasını
...
- [MTN Hackers Platform'ın (DVWA) Windows 10'da kurulumu](https://www.youtube.com/watch?v=cak2lQvBRAo) [12:39 dakika]
